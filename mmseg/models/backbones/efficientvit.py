...
from mmseg.models.backbones.Lightweight_efficientvit.utils import load_state_dict_from_file
...
from .Lightweight_efficientvit.utils import build_kwargs_from_config
...
class EfficientViTBackbone(nn.Module):
    ...
    def forward(self, x) :
        ...
        # print('stage_final')
        # print(x.shape) # 1x256x32x64

        return output_dict

    def init_weights(self, pretrained=None):
       # weight_url = weight_url or REGISTERED_CLS_MODEL.get(name, None)
        #pretrained = "/mnt/share/ljx/swintransformer/Swin-Transformer-Semantic-Segmentation-main/lightweight_Efficientvit_checkpoint/b1-r224.pt"
