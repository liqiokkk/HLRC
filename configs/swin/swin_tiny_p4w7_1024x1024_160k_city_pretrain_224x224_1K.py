_base_ = [
    '../_base_/models/upernet_swin_refine.py', '../_base_/datasets/cityscapes_1024x1024.py',
...
model = dict(
    ...
    # test_cfg=dict(mode='slide', crop_size=(1024, 512), stride=(1024, 512)))
